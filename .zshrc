...
alias v='nvim +NvimTreeOpen'
alias vi='nvim'
alias mv='mv -v'
alias cp='cp -vr'
alias rm='rm -vr'
alias bar='bash ~/.config/polybar/launch.sh --colorblocks'
alias dwmconf='cd ~/.config/chadwm/chadwm/; nvim config.def.h; sudo make clean install'
alias neofetch='clear;neofetch'
alias brave='brave-nightly --enable-features=UseOzonePlatform --ozone-platform=wayland'
alias scrot='wayshot'
